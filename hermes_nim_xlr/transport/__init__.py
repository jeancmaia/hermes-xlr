...
Critical invariant (HER-18 / AGENTS.md §1): **zero per-turn entropy**. No
...
class XLRTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params: Any,
        ...
        # KV-cache block reuse (prefix caching, lever 1).
        ...
        # Layer placement — how many transformer layers run on the GPU.
